...
@interface SFLibLiveViewerModel : MTLModel<MTLJSONSerializing>
...
@interface SFLibLiveViewerList : MTLModel<MTLJSONSerializing>
...
@interface SFLibLiveViewerResponse : MTLModel<MTLJSONSerializing>

@property (nonatomic, assign) NSInteger retcode;
@property (nonatomic, copy) NSString *retmsg;
@property (nonatomic, copy) SFLibLiveViewerList *result;
